...
import { CLI_INSTALLERS } from "../../../../shared/cli-installers";
...
export function CliInstallerDialog({
  ...
  return (
    <Dialog
      title="安装 CLI"
      onClose={onClose}
      className="cli-installer-dialog"
    ...
    >
      <p className="dialog-hint">选择已集成的 AI 厂商，在当前目标环境执行 npm 全局安装。Node 缺失或版本不足时，会优先使用已安装的 nvm 安装 Node。</p>
